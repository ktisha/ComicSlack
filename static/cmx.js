...
define("svginnerhtml", function(){});

(function() {

  define('cmx/view',[],function() {
    var View;
...
(function() {
  ...
  define('cmx/drawable',['cmx/view'], function(View) {
    var Drawable;
    return Drawable = (function(_super) {
      ...
      Drawable.prototype.buildGizmos = function(root) {
        var newRoot, view, _i, _len, _ref, _results;
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          _results.push(view.gizmo.update());
        }
        return _results;
      };

      Drawable.prototype.update = function() {
        var call, _i, _len, _ref, _ref1;
        if ((_ref = this.gizmo) != null) {
          _ref.update();
        }
        _ref1 = this.renderCalls;
...
(function() {
  ...
  define('cmx/gizmo',['cmx/drawable'], function(Drawable) {
    var Gizmo, initialUndoValue, undoEval;
    initialUndoValue = void 0;
    undoEval = void 0;
    return Gizmo = (function(_super) {
      ...
      Gizmo.prototype.controlUndoOpen = function() {
        var getter, params, setter, what,
          _this = this;
        what = arguments[0], params = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
        getter = "get" + _.str.classify(what);
        setter = "set" + _.str.classify(what);
        undoEval = function(val) {
          if (val) {
...
(function() {
  ...
  define('cmx/controller',['cmx/gizmo'], function(Gizmo) {
    ...
    return Controller = (function() {
      ...
      Controller.prototype.makeEditable = function() {
        var scene, sceneModel, _i, _len, _ref,
          _this = this;
        _ref = this.scenes;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          sceneModel = _ref[_i];
        ...
        return $("html").bind("click", function(event) {
  ...
  define('cmx/model',[],function() {
    ...
    return Model = (function() {
      ...
      Model.prototype.writeProps = function(props, $source) {
        var defaults, prop, val, _ref, _results;
        defaults = this.computeDefaults();
        _ref = _.pick(props, this.mutableProps);
        _results = [];
        for (prop in _ref) {
          val = _ref[prop];
          if (val === defaults[prop]) {
            _results.push($source.removeAttr(prop));
          } else {
            _results.push($source.attr(prop, val));
          }
        }
        return _results;
      };
      ...
      Model.prototype.debugReport = function(indent, logger) {
        var child, displayableProps, indenting, _i, _j, _len, _ref, _results, _results1;
        if (indent == null) {
          indent = 0;
        }
        if (logger == null) {
        ...
        for (_j = 0, _len = _ref.length; _j < _len; _j++) {
          child = _ref[_j];
          _results1.push(child.debugReport(indent + 2, logger));
        }
        return _results1;
      };
    ...
    return XKCD = (function() {
      ...
      XKCD.prototype.render = function(points, xlim, ylim, magnitude) {
        ...
        dists.map(function(d, i) {
          var delta, j, n, spline, x, _results;
          if (i === 0) {
            return;
          }
...
(function() {
  ...
  define('cmx/skelet',['cmx/bone'], function(Bone) {
    var Skelet;
    return Skelet = (function() {
      ...
      Skelet.prototype.addBones = function(bonedefs) {
        var args, list, _i, _len;
        if (bonedefs == null) {
          bonedefs = [];
        }
        list = [];
        for (_i = 0, _len = bonedefs.length; _i < _len; _i++) {
          args = bonedefs[_i];
      ...
      Skelet.prototype.addStructure = function(defs) {
        ...
        for (arg in defs) {
          val = defs[arg];
          _results.push(this.structure[arg] = val);
        }
        return _results;
      };

      Skelet.prototype.boneIndex = function(name) {
        var bone, i, _i, _len, _ref;
        _ref = this.bones;
      ...
      Skelet.prototype.bonesWithIndices = function(boneIndices) {
        var _this = this;
        return boneIndices.map(function(index) {
          return _this.bones[index];
        });
      };

      Skelet.prototype.moveBone = function(boneNames, dx, dy, absolute) {
        var affectedBones, bone, boneName, mx, my, _i, _len, _results;
        if (absolute == null) {
          absolute = false;
        }
        ...
        _results = [];
        for (_i = 0, _len = boneNames.length; _i < _len; _i++) {
          boneName = boneNames[_i];
          ...
          _results.push((function() {
            ...
            _results1 = [];
            for (_j = 0, _len1 = affectedBones.length; _j < _len1; _j++) {
              boneName = affectedBones[_j];
              bone = this.boneIndex(boneName);
              this.bones[bone].x -= mx;
              _results1.push(this.bones[bone].y -= my);
            }
            return _results1;
          }).call(this));
        }
      ...
      Skelet.prototype.getPose = function(boneIndices) {
        var bone, boneIndex, pose, _i, _len;
        pose = [];
        for (_i = 0, _len = boneIndices.length; _i < _len; _i++) {
          boneIndex = boneIndices[_i];
      ...
      Skelet.prototype.setPose = function(pose, boneIndices) {
        var i, index, point, _i, _len, _results;
        _results = [];
        for (i = _i = 0, _len = pose.length; _i < _len; i = ++_i) {
          point = pose[i];
          index = boneIndices[i];
          if (index === void 0) {
            continue;
          ...
          _results.push(this.bones[index].y = point[1]);
        }
        return _results;
      };
...
(function() {
  ...
  define('cmx/renderer',['cmx/XKCD'], function(XKCD) {
    ...
    return Renderer = (function() {
      ...
      Renderer.prototype.draw = function(Δelement) {
        var item, Δ, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3;
        if (!Δelement) {
        ...
        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
          ...
          item.update = function() {
            var update, _l, _len3, _ref3, _results;
            if (!this.updaters) {
              return;
            }
            _ref3 = this.updaters;
...
(function() {
  ...
  define('cmx/scene',['cmx/drawable', 'cmx/renderer', 'cmx/overlay', 'cmx/gizmo'], function(Drawable, Renderer, Overlay, Gizmo) {
    var Scene;
    return Scene = (function(_super) {

      __extends(Scene, _super);

      function Scene(cmx, rootElement, width, height, frame, marginX, marginY) {
        this.cmx = cmx;
      ...
      Scene.prototype.drawScene = function() {
        var layerId, layers, view, Δentity, Δg, Δlayer, _i, _ref, _results;
        ...
        _results = [];
        for (layerId = _i = _ref = layers.length - 1; _ref <= 0 ? _i <= 0 : _i >= 0; layerId = _ref <= 0 ? ++_i : --_i) {
          ...
          _results.push((function() {
            ...
            for (_j = 0, _len = _ref1.length; _j < _len; _j++) {
              ...
              view.draw(layerId);
              _results1.push(this.renderer.draw(Δentity));
            }
            return _results1;
          }).call(this));
        }
      ...
      Scene.prototype.buildGizmos = function() {
        ...
        return this.renderer.Δlayers.selectAll(".cmx-entity").on("click", function(event) {
          var gizmo, _ref, _ref1;
          gizmo = (_ref = this.cmx) != null ? (_ref1 = _ref.entity) != null ? _ref1.gizmo : void 0 : void 0;
          if (gizmo) {
            gizmo.select();
...
(function() {
  ...
  define('cmx/gizmos/entity_gizmo',['cmx/gizmo'], function(Gizmo) {
    ...
    MARKER_SY = 3;
    MARKER_SQ = 4;
    return EntityGizmo = (function(_super) {

      __extends(EntityGizmo, _super);
      ...
      EntityGizmo.prototype.update = function() {
        var _ref,
          _this = this;
        if ((_ref = this.ΔentityGizmo) != null) {
          _ref.attr("transform", this.entity.getEffectiveFrame()).selectAll(".cmx-marker").attr("transform", function(marker) {
            var pos;
      ...
      EntityGizmo.prototype.build = function(root) {
        ...
        drag = d3.behavior.drag().base(function(target) {
          return target.parentNode.parentNode;
        }).on("dragstart", function(bone) {
...
(function() {
  ...
  define('cmx/entity',['cmx/drawable', 'cmx/gizmos/entity_gizmo', 'cmx/skelet'], function(Drawable, EntityGizmo, Skelet) {
    var Entity;
    return Entity = (function(_super) {
      ...
      Entity.prototype.openLayer = function(layer) {
        var _this = this;
        return this.openFrame((function() {
      ...
      Entity.prototype.highlightBones = function(root, bones) {
        ...
        return root.selectAll(".cmx-control").each(function(d, bone) {
          var _ref;
          if (_ref = d.name, __indexOf.call(bones, _ref) >= 0) {
...
(function() {
  ...
  define('cmx/models/scene_model',['cmx/model', 'cmx/scene'], function(Model, Scene) {
    var SceneModel;
    return SceneModel = (function(_super) {
      ...
      SceneModel.prototype.materialize = function($where) {
        ...
        $wrapper = $("<div/>").attr('class', 'cmx-scene').attr('onload', "saveAsPng()");
...
(function() {
  ...
  define('cmx/gizmos/actor_gizmo',['cmx/gizmos/entity_gizmo'], function(EntityGizmo) {
    var ActorGizmo;
    return ActorGizmo = (function(_super) {

      __extends(ActorGizmo, _super);
      ...
      ActorGizmo.prototype.update = function() {
        ...
        return (_ref = this.ΔskeletonGizmo) != null ? _ref.selectAll(".cmx-control").attr("cx", function(bone) {
          return bone.x;
        }).attr("cy", function(bone) {
          return bone.y;
        }).style("display", function(bone) {}) : void 0;
      };
      ...
      ActorGizmo.prototype.build = function() {
        ...
        resetBone = function(bone) {
          _this.entity.skelet.moveBone(bone.name, 0, 0, true);
          return _this.entity.throttledUpdate();
        };
        doubleClick = function(bone) {
          d3.event.preventDefault();
          if (bone.type === "l") {
        ...
        drag = d3.behavior.drag().on("dragstart", function(bone) {
...
(function() {
  ...
  define('cmx/entities/actor',['cmx/entity', 'cmx/gizmos/actor_gizmo'], function(Entity, ActorGizmo) {
    var Actor;
    return Actor = (function(_super) {
      ...
      Actor.prototype.drawBody = function() {
        ...
        return this.register(this.scene.renderer.path((function() {
          return bodyPath();
        })));
      };
      ...
      Actor.prototype.drawLegs = function() {
        var bonePos,
          _this = this;
        bonePos = function(name) {
          var bone;
          bone = _this.skelet.bone(name);
          return [bone.x, bone.y];
        };
        this.register(this.scene.renderer.line((function() {
          return _this.legs[0].map(bonePos);
        })));
        return this.register(this.scene.renderer.line((function() {
...
(function() {
  ...
  define('cmx/models/actor_model',['cmx/model', 'cmx/entities/actor'], function(Model, Actor) {
    var ActorModel;
    return ActorModel = (function(_super) {
...
(function() {
  ...
  define('cmx/gizmos/bubble_gizmo',['cmx/gizmos/entity_gizmo'], function(EntityGizmo) {
    var BubbleGizmo;
    return BubbleGizmo = (function(_super) {

      __extends(BubbleGizmo, _super);

      function BubbleGizmo() {
        return BubbleGizmo.__super__.constructor.apply(this, arguments);
      }

      BubbleGizmo.prototype.update = function() {
        var _ref,
          _this = this;
        BubbleGizmo.__super__.update.apply(this, arguments);
        return (_ref = this.ΔskeletonGizmo) != null ? _ref.selectAll(".cmx-control").attr("cx", function(bone) {
          return bone.x;
        }).attr("cy", function(bone) {
          return bone.y;
      ...
      BubbleGizmo.prototype.build = function() {
        var base, data, doubleClick, drag, resetBone,
          _this = this;
        base = BubbleGizmo.__super__.build.apply(this, arguments);
        this.ΔskeletonGizmo = base.append("g").attr("class", "cmx-gizmo cmx-bubble");
        resetBone = function(bone) {
          _this.entity.skelet.moveBone(bone.name, 0, 0, true);
          return _this.entity.throttledUpdate();
        };
        ...
        data = this.entity.skelet.bonesWithIndices(this.entity.bubbleBones);
        this.ΔskeletonGizmo.selectAll(".cmx-control").data(data).enter().append("circle").attr("class", function(bone) {
          return "cmx-control cmx-" + bone.type;
        }).attr("r", this.CONTROL_POINT_RADIUS).on("dblclick", doubleClick).call(drag);
        return this.ΔskeletonGizmo;
...
(function() {
  ...
  define('cmx/entities/bubble',['cmx/entity', 'cmx/gizmos/bubble_gizmo'], function(Entity, BubbleGizmo) {
    var Bubble;
    return Bubble = (function(_super) {
...
(function() {
  ...
  define('cmx/models/bubble_model',['cmx/model', 'cmx/entities/bubble'], function(Model, Bubble) {
    var BubbleModel;
    return BubbleModel = (function(_super) {

      __extends(BubbleModel, _super);
...
(function() {
  ...
  define('cmx/gizmos/drawing_gizmo',['cmx/gizmos/entity_gizmo'], function(EntityGizmo) {
    var DrawingGizmo;
    return DrawingGizmo = (function(_super) {

      __extends(DrawingGizmo, _super);

      function DrawingGizmo() {
        return DrawingGizmo.__super__.constructor.apply(this, arguments);
      }

      DrawingGizmo.prototype.update = function() {
        var _ref,
          _this = this;
        DrawingGizmo.__super__.update.apply(this, arguments);
        return (_ref = this.ΔskeletonGizmo) != null ? _ref.selectAll(".cmx-control").attr("cx", function(bone) {
          return bone.x;
        }).attr("cy", function(bone) {
          return bone.y;
      ...
      DrawingGizmo.prototype.build = function() {
        var base, data, doubleClick, drag, resetBone,
          _this = this;
        base = DrawingGizmo.__super__.build.apply(this, arguments);
...
(function() {
  ...
  define('cmx/entities/drawing',['cmx/entity', 'cmx/gizmos/drawing_gizmo'], function(Entity, DrawingGizmo) {
    var Drawing;
    return Drawing = (function(_super) {
      ...
      Drawing.prototype.drawLayer = function(layer) {
        var item, itemsToBeRendered, _i, _len,
          _this = this;
        ...
        for (_i = 0, _len = itemsToBeRendered.length; _i < _len; _i++) {
          item = itemsToBeRendered[_i];
...
(function() {
  ...
  define('cmx/models/drawing_model',['cmx/model', 'cmx/entities/drawing'], function(Model, Drawing) {
    var DEFAULT_LAYER, DrawingModel;
    DEFAULT_LAYER = 2;
    return DrawingModel = (function(_super) {

      __extends(DrawingModel, _super);
        ...
        if (props["content"]) {
          ...
          $parser.children().each(function() {
            ...
            collectOpts = function($el) {
              var attr, key, res, val, _i, _len, _ref;
              res = {};
              _ref = $el.get(0).attributes;
              for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                attr = _ref[_i];
...
(function() {
  ...
  define('cmx/gizmos/label_gizmo',['cmx/gizmos/entity_gizmo'], function(EntityGizmo) {
    var LabelGizmo;
    return LabelGizmo = (function(_super) {

      __extends(LabelGizmo, _super);
...
(function() {
  ...
  define('cmx/entities/label',['cmx/entity', 'cmx/gizmos/label_gizmo'], function(Entity, LabelGizmo) {
    var Label;
...
(function() {
  ...
  define('cmx/models/label_model',['cmx/model', 'cmx/entities/label'], function(Model, Label) {
    var LabelModel;
    return LabelModel = (function(_super) {
...
(function() {
  ...
  define('cmx/parser',["cmx/models/scene_model", "cmx/models/actor_model", "cmx/models/bubble_model", "cmx/models/drawing_model", "cmx/models/label_model"], function() {
    var Parser, defaultModels, klass, modelClasses, _i, _len;
    modelClasses = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    defaultModels = {};
    for (_i = 0, _len = modelClasses.length; _i < _len; _i++) {
      klass = modelClasses[_i];
    ...
    return Parser = (function() {
      ...
      Parser.prototype.collectProps = function($el) {
        var attr, content, key, params, res, val, _j, _len1, _ref;
        res = {};
        content = $el.html();
        if (content) {
          res["content"] = content;
      ...
      Parser.prototype.parseDoc = function(doc) {
        var $doc, $scene, res, scene, sceneModel, walk, _j, _len1, _ref,
          _this = this;
        $doc = $(doc);
        walk = function($el) {
          var $child, child, childModel, model, _j, _len1, _ref;
